    ...
    <div class="content-wrapper">
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li><a href="{{ route('App.Show', $appEntity) }}"><i class="fa fa-star-o"></i> {{ $appEntity->name }}</a></li>
                    ...
                    <div class="box box-danger">
                        <div class="box-header with-border">
                            ...
                            <div class="box-tools pull-right">
                                <button
                                    class="btn btn-link btn-box-tool runSelectedTests" style="color: #354eb5;"
                                >
                                    ...
                                    <div class="tab-content">
                                        <div class="tab-pane active" id="tab_app_0">
                                            <table class="table table-bordered tableTests">
                                                ...
                                                <tbody>
                                                @foreach($appEntity->tags as $key_tag=> $tagEntity)
                                        ...
                                        @foreach($appEntity->tags as $key_tag=> $tagEntity)
                                            @foreach($tagEntity->tests->sortBy('name') as $key=> $test)
                                                <div class="tab-pane" id="tab_app_{{ $key_tag }}_{{$key +1 }}">
                                                    <table class="table table-bordered tableTests">
                                                        <thead>
                                                        <tr>
                                                            <th style="width: 1%">
